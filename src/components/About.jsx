    ...
    return (
        <div name="about" className='w-full h-full bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <button className='flex-row ease-in gap-2 group rounded bg-gradient-to-b from-cyan-500 to-blue-500 w-1/2 h-12 mx-auto flex items-center justify-center cursor-pointer mt-10 mb-10 hover:scale-105 duration-300 sm:ease-in'
                >
